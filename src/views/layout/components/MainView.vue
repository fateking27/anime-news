<template>
          ...
          <el-tab-pane label="最新资讯" name="first">
            <div class="items" style="
              ...
              <div class="content" style="width: 600px">
                <div class="title">
                  <el-text size="large" tag="b" truncated>Aniplex新作动画代号《O》《M》制作决定 物语系列Off＆Monster Season</el-text>
                </div>
            ...
            <div class="refresh" style="position: relative; left: 45%; margin-bottom: 10px">
              <el-button :icon="RefreshRight" style="border: 1px solid #409efc; color: #409efc">加载更多</el-button>
            </div>
          </el-tab-pane>
  ...
  <!-- <div class="left">
      ...
      <el-card shadow="never" class="card_3" :body-style="{ padding: '0px' }"
        style="margin-top: 15px; border-radius: 10px; border: none">
        <div class="title" style="
            ...
            padding-bottom: 5px;
          ">
          <div style="width: 15px; height: 15px; background-color: #fcaa40; border-radius: 50%"></div>
          <div style="
              width: 15px;
              height: 15px;
        ...
        <div class="items">
          <div class="first_item" style="
            ...
            <div class="title" style="
                width: 23px;
                height: 20px;
                background-color: rgb(252, 91, 63);
                color: white;
                text-align: right;
                line-height: 20px;
          ...
          <div class="next_items" style="margin-top: 5px;">
            ...
            " v-for="item in 4">
              ...
              <div class="title" style="margin-top: -20px;margin-left: 10px;cursor: pointer;">Aniplex新作动画代号《O》《M》制作决定
              </div>
            </div>
          </div>
        </div>
